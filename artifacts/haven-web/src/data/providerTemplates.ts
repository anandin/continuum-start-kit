...
export const providerTemplates: ProviderTemplate[] = [
  {
    ...
    methodology:
      "This program follows the established CBT framework focused on identifying and restructuring negative thought patterns, developing coping strategies, and creating behavioral change through structured intervention. The approach emphasizes the connection between thoughts, feelings, and behaviors, using evidence-based techniques to help clients achieve measurable therapeutic outcomes.",
    stages: [
      {
        name: "Assessment & Engagement",
        description:
          "Initial evaluation, building therapeutic alliance, and identifying core issues and automatic thoughts",
      },
      {
        name: "Psychoeducation",
        description:
          "Teaching CBT model, explaining the relationship between thoughts-feelings-behaviors, and normalizing experiences",
      },
      {
        name: "Cognitive Restructuring",
        description:
          "Identifying cognitive distortions, challenging negative thoughts, and developing alternative perspectives",
      },
      {
        name: "Behavioral Activation",
        description:
          "Implementing behavioral experiments, activity scheduling, and exposure exercises",
      },
      {
        name: "Skill Consolidation",
        description:
          "Practicing coping strategies, building resilience, and preparing for challenging situations",
      },
      {
        name: "Relapse Prevention",
        description:
          "Developing maintenance plan, identifying warning signs, and establishing ongoing self-monitoring",
      },
    ],
    labels: [
    ...
    trajectoryRules: [
      {
        ...
        indicator_type: "leap",
        pattern:
          "successfully challenged core belief|identified alternative perspective|reduced distortion",
        message:
          "Strong cognitive breakthrough - client demonstrating advanced restructuring skills",
      },
      {
        stage: "Behavioral Activation",
        indicator_type: "drift",
        pattern:
          "avoided exposure|canceled activity|increased safety behaviors",
        message:
          "Avoidance pattern emerging - revisit behavioral activation rationale",
      },
      {
        ...
        message:
          "Consistent skill application - ready for relapse prevention planning",
      },
    ],
  },
  {
    ...
    description:
      "Leadership development for senior executives and high-performers",
    ...
    stages: [
      {
        ...
        description:
          "Conducting 360 reviews, identifying leadership gaps, and establishing development priorities",
      },
      {
        name: "Executive Presence",
        description:
          "Building gravitas, communication impact, and authentic leadership style",
      },
      {
        name: "Strategic Influence",
        description:
          "Mastering organizational politics, stakeholder management, and cross-functional leadership",
      },
      {
        name: "Assertive Leadership",
        description:
          "Developing decisive communication, boundary setting, and confident decision-making",
      },
      {
        name: "Team & Culture Mastery",
        description:
          "Leading organizational change, building high-performing teams, and shaping culture",
      },
      {
        name: "Sustained Excellence",
        description:
          "Maintaining peak performance, work-life integration, and continuous leadership evolution",
      },
    ],
    labels: [
      "executive presence",
    ...
    trajectoryRules: [
      {
        ...
        indicator_type: "leap",
        pattern:
          "received positive feedback|demonstrated gravitas|commanded room",
        message:
          "Significant presence breakthrough - client showing authentic leadership voice",
      },
      {
        stage: "Strategic Influence",
        indicator_type: "drift",
        pattern:
          "avoided difficult conversation|bypassed key stakeholder|missed political opportunity",
        message:
          "Influence gap appearing - explore fears around political navigation",
      },
      {
        stage: "Assertive Leadership",
        indicator_type: "steady",
        pattern:
          "set clear boundaries|made decisive call|communicated expectations",
        message:
          "Consistent assertiveness - building sustainable leadership patterns",
      },
    ],
  },
  {
    ...
    methodology:
      "Integrative spiritual development framework drawing from Dr. Joe Dispenza's neuroscience-based transformation, Deepak Chopra's consciousness teachings, Sadhguru's yogic wisdom, Dolores Cannon's quantum healing hypnosis, and Bashar's higher consciousness principles. Focuses on raising vibration, dissolving limiting beliefs, accessing higher states of consciousness, and aligning with authentic soul purpose.",
    stages: [
      {
        name: "Awakening & Awareness",
        description:
          "Initial spiritual opening, recognizing patterns, and beginning to question conditioned reality",
      },
      {
        name: "Shadow Integration",
        description:
          "Confronting and healing past traumas, releasing energetic blocks, and embracing shadow aspects",
      },
      {
        name: "Vibrational Mastery",
        description:
          "Learning to consciously shift frequency, maintain high vibration, and embody desired states",
      },
      {
        name: "Quantum Leap",
        description:
          "Breaking through old paradigms, accessing higher timelines, and manifesting new reality",
      },
      {
        name: "Soul Alignment",
        description:
          "Living from authentic purpose, following inner guidance, and co-creating with universe",
      },
      {
        name: "Service & Embodiment",
        description:
          "Grounded spiritual integration, serving others, and anchoring higher consciousness",
      },
    ],
    labels: [
    ...
    trajectoryRules: [
      {
        ...
        indicator_type: "leap",
        pattern:
          "sustained high vibration|manifested desired outcome|accessed flow state",
        message:
          "Powerful vibrational shift - client mastering frequency control",
      },
      {
        stage: "Shadow Integration",
        indicator_type: "drift",
        pattern:
          "avoiding shadow work|resisting healing|staying in victim consciousness",
        message:
          "Shadow resistance surfacing - gentle encouragement toward deeper work",
      },
      {
    ...
    stages: [
      {
        ...
        description:
          "Case evaluation, explaining legal process, gathering financial documents, and setting expectations",
      },
      {
        name: "Filing & Response",
        description:
          "Preparing and filing petition, serving spouse, and responding to counter-petitions",
      },
      {
        name: "Discovery & Disclosure",
        description:
          "Financial disclosure, interrogatories, depositions, and gathering evidence",
      },
      {
        name: "Negotiation & Mediation",
        description:
          "Settlement discussions, mediation sessions, and exploring resolution options",
      },
      {
        name: "Trial Preparation",
        description:
          "If settlement fails - preparing for court, organizing evidence, and witness preparation",
      },
      {
        name: "Final Resolution",
        description:
          "Executing settlement agreement or judgment, finalizing custody orders, and post-decree matters",
      },
    ],
    labels: [
      "asset division",
    ...
    trajectoryRules: [
      {
        ...
        message:
          "Positive settlement progress - maintaining momentum toward resolution",
      },
      {
