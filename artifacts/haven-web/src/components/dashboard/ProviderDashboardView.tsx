    ...
    <div className="space-y-6 animate-fade-in">
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="shadow-warm" data-testid="card-active-clients">
          ...
          <CardContent>
            <div className="text-3xl font-semibold text-foreground">{activeClients}</div>
        ...
        <Card className="shadow-warm" data-testid="card-sessions-week">
          ...
          <CardContent>
            <div className="text-3xl font-semibold text-foreground">{sessionsThisWeek}</div>
        ...
        <Card className="shadow-warm" data-testid="card-accelerating">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Thriving</CardTitle>
            <TrendingUp className="h-4 w-4 text-success" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-semibold text-foreground">{accelerating}</div>
            <p className="text-xs text-muted-foreground mt-1">Strong progress</p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-warm" data-testid="card-at-risk">
          ...
          <CardContent>
            <div className="text-3xl font-semibold text-foreground">{atRisk}</div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between mb-1.5">
                                <div>
                                  <h4 className="font-medium text-foreground text-sm">{getSeekerAlias(engagement)}</h4>
        ...
        <div className="space-y-4">
          ...
          <Card className="shadow-warm bg-gradient-warm-card" data-testid="card-health-stats">
            <CardHeader>
