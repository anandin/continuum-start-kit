...
export default function Home() {
  ...
  const handleMoodSelect = useCallback(async (label: string, score: number) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            "I think I keep waiting for permission to rest — like I haven't
            earned it yet."
          </p>
        ...
        >
          ...
          >
            Last time we talked about rest and permission — there's something
            gentle I'd love to explore with you when you're ready.
          </p>
