...
export default function Onboarding() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(
        `Welcome! You're starting at "${stageAssignment.initial_stage}"`,
      );
      if (needsPaymentSetup) {
            ...
            <Card className="p-8">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg">
                      Take a moment to reflect. What's the main struggle or pain
                      you're experiencing right now? There are no wrong answers
                      here.
                    </p>
                  </div>
                  <Textarea
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg">
                      Close your eyes for a moment. Where do you want to be?
              ...
              {step === 3 && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg">
                      Understanding your obstacles is the first step to moving
                      past them. What's your biggest challenge right now?
                    </p>
                  </div>
                  <Textarea
              ...
              {step === 4 && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg">
                      Growth happens in small steps. Tell me about a recent win,
                      big or small. What went well for you?
                    </p>
                  </div>
                  <Textarea
                    value={recentWin}
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg mb-6">
                      Based on what you've shared, here are coaches who can walk
                  ...
                  <div className="space-y-4">
                    {providers.length === 0 ? (
                      <div
                        ...
                        data-testid="loading-providers"
                      >
                        <Loader2 className="h-8 w-8 animate-spin text-primary mx-auto mb-4" />
                        <p className="text-muted-foreground">
                          Finding the right coaches for you...
                        </p>
                      </div>
                    ) : (
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg mb-4">
                      Sliding-scale pricing — pay what fits your situation. You
                      can change this any time on your Payment page.
                    </p>
                  </div>
                  {tiersLoading ? (
                    ...
                    <div
                      className="rounded-md bg-secondary/40 p-4 text-sm text-muted-foreground"
                      data-testid="onboarding-no-tiers"
                    >
                      Your coach hasn't published pricing tiers yet. You can
                      continue and pick a tier later from your Payment page.
                    </div>
                  ) : (
              ...
              {step === 7 && selectedProvider && (
                <div className="space-y-6">
                  ...
                  <div
                    className="bg-secondary/50 rounded-md p-6 space-y-4"
                  ...
                  <div
                    ...
                    data-testid="text-journey-info"
                  >
                    <p className="text-muted-foreground text-sm">
                      We'll determine your starting point based on your
                      responses and gently guide you through each step of your
                      journey.
                    </p>
                  </div>
                </div>
