...
export default function ClientSessionSummary() {
  ...
  const playbooksQ = useQuery<PlaybookOption[]>({
    ...
    queryFn: async () =>
      (await apiRequest("GET", "/api/twin/playbooks")).json(),
    enabled: !!user,
  });
  ...
  const setPlaybookMut = useMutation({
    mutationFn: async (playbookId: string | null) =>
      (
        await apiRequest("PATCH", `/api/engagements/${clientId}/playbook`, {
          playbookId,
        })
      ).json(),
  ...
  const loadEngagementDetails = async () => {
    try {
      ...
      const engagementRes = await fetch(`/api/engagements/${clientId}`, {
        credentials: "include",
      });
      if (!engagementRes.ok) {
      ...
      const sessionsRes = await fetch(`/api/engagements/${clientId}/sessions`, {
        credentials: "include",
      });
    ...
    return (
      <AppLayout title="Client overview">
        <div
          ...
          data-testid="loading-client-summary"
        >
  ...
  const trajectoryStatus =
    getSummaryField(latestSummary, "trajectoryStatus", "trajectory_status") ||
    "steady";
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    data-testid="text-engagement-id"
                  >
                    Engagement ID: {engagement.id.slice(0, 8)}
                  </p>
                </div>
              </div>
              <div className="flex gap-2 items-center flex-wrap">
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    value={
                      engagement.playbookId ??
                      engagement.playbook_id ??
                      "__default__"
                    }
                    onValueChange={(val) =>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem
                        value="__default__"
                        data-testid="option-playbook-default"
                      >
                        Use default
                        {(() => {
                ...
                <Button
                  variant="outline"
                  onClick={() =>
                    navigate(`/provider/twin/memory/${engagement.id}`)
                  }
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <div className="lg:col-span-2 space-y-4">
                <Card
                  ...
                  data-testid="card-latest-summary"
                >
                  <CardHeader>
                    ...
                    {latestSummary ? (
                      <>
                        ...
                        <div className="rounded-md bg-muted/50 p-4">
                          ...
                          <p
                            ...
                            data-testid="text-session-overview"
                          >
                            {getSummaryField(
                              latestSummary,
                              "sessionSummary",
                        ...
                        {(() => {
                          const insights = getSummaryField(
                            latestSummary,
                            "keyInsights",
                            "key_insights",
                          );
                      ...
                      >
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          A summary will appear after the client completes a
                          session.
                        </p>
                      </div>
                    )}
                    ...
                    {sessions.length > 0 ? (
                      <div className="space-y-3">
                        {sessions.map((session) => {
                          ...
                          const stage =
                            session.initialStage || session.initial_stage;
                          const tStatus = summary
                            ? getSummaryField(
                                summary,
                                "trajectoryStatus",
                                "trajectory_status",
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between gap-2 flex-wrap">
                        ...
                        <Badge data-testid="badge-profile-stage">
                          {sessions[0]?.initialStage ||
                            sessions[0]?.initial_stage ||
                            "N/A"}
                        </Badge>
                      </div>
                      <div className="flex items-center justify-between gap-2 flex-wrap">
  ...
  return (
    <Card className="shadow-warm">
      <CardHeader>
        ...
        <CardDescription>
          What this client shared during onboarding
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isLoading ? (
