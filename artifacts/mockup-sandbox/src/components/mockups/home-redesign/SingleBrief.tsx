        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <section className="px-5 py-3 border-t border-[#E5E5E0] flex items-center gap-4">
            <div className="flex-1">
              <span className="block text-[10px] uppercase tracking-wider text-[#666666] font-bold mb-0.5">
                Sessions
              </span>
          ...
          <section className="px-5 py-3 border-t border-[#E5E5E0]">
            <div className="flex items-baseline justify-between mb-1.5">
              ...
              <span className="text-[10px] uppercase tracking-wider text-[#999999] font-bold">
                14-day mood
              </span>
            </div>
          ...
          <section className="px-5 py-3 border-t border-[#E5E5E0]">
            ...
            <div className="mb-3">
              <h3 className="text-[10px] font-bold uppercase tracking-wider text-[#666666] mb-1.5">
                Insights
              </h3>
              <ol className="space-y-1">
                <li className="flex gap-2 text-[12px] leading-snug">
                  <span className="text-[#164E36] font-bold flex-shrink-0">
                    1
                  </span>
            ...
            <div className="mb-2">
              ...
              <ul className="space-y-1">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-[12px] leading-tight line-through text-[#999999]">
                    10-minute walk before noon
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-3.5 h-3.5 rounded-[3px] border border-[#E5E5E0] flex-shrink-0" />
                  <span className="text-[12px] leading-tight text-[#1A1A1A]">
                    Text Mom back
                  </span>
                </li>
                <li className="flex items-center gap-2">
            ...
            <p className="text-[12px] italic leading-snug text-[#666666] pt-2 border-t border-[#E5E5E0]">
              <span className="not-italic font-bold uppercase tracking-wider text-[10px] text-[#164E36] mr-1.5">
                Try
              </span>
