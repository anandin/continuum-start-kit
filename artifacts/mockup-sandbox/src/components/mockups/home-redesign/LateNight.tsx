        ...
        <div className="flex-1 overflow-y-auto px-6 pb-24 space-y-10 no-scrollbar">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[15px] opacity-60 leading-relaxed max-w-[90%]">
              Last session was Thursday. You can pick up where you left off, or
              just sit a moment.
            </p>
          ...
          <div className="space-y-4">
            <h2 className="text-[15px] font-medium opacity-80">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              >
                <path
                  d="M0 6L6 9L12 9L18 12L24 6L30 9L36 12L42 9L48 9L54 6L60 6"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
          ...
          <div className="space-y-6">
            <div className="space-y-1">
              ...
              <p className="text-[13px] opacity-50">
                You're in Stage 2 — moving through avoidance.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-[#1a140f] p-4 rounded-xl border border-[#E8DFD0]/5 space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium uppercase tracking-wider text-[#E5B567]">
                    Try this tonight
                  </span>
                </div>
            ...
            >
              <span className="text-sm opacity-50 group-hover:opacity-80 transition-opacity">
                3 things you set for today
              </span>
              <ChevronDown
                className={`w-4 h-4 opacity-30 transition-transform ${goalsOpen ? "rotate-180" : ""}`}
              />
            </button>
            ...
            {goalsOpen && (
              <div className="space-y-3 pt-2 opacity-70">
                ...
                <label className="flex items-start gap-3">
                  <div className="mt-0.5 flex-shrink-0 w-4 h-4 rounded-sm border border-[#E8DFD0]/30 flex items-center justify-center"></div>
            ...
            <button className="flex items-center justify-between w-full py-3 px-4 rounded-xl bg-[#E5B567]/10 border border-[#E5B567]/20 hover:bg-[#E5B567]/15 transition-colors group mt-4">
              <span className="text-sm font-medium text-[#E5B567]">
          ...
          <button className="flex items-center justify-between w-full py-2 group">
            <span className="text-sm font-medium opacity-60 group-hover:opacity-90 transition-opacity">
              View full progress
            </span>
