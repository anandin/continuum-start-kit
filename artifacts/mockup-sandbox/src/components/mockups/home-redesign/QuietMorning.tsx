      ...
      <div className="relative w-[390px] h-[844px] bg-paper overflow-hidden shadow-2xl rounded-[40px] border-[8px] border-neutral-800 text-brown flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto hide-scrollbar pb-24">
          ...
          <div className="px-6 pt-6 pb-8">
            <h1 className="font-serif text-[32px] leading-tight text-brown mb-2">
              Good evening, Alex
            </h1>
          ...
          <div className="px-6 py-8 flex flex-col gap-3">
            <div className="flex justify-between items-baseline">
              <span className="text-[11px] uppercase tracking-widest text-brown-muted font-medium">
                Sessions
              </span>
          ...
          <div className="px-6 py-8">
            ...
            <div className="flex items-end gap-[3px] h-8 mt-6">
              {[4, 3, 3, null, 4, 3, 2, 3, 3, null, 3, 3, 3, 3].map(
                (val, i) => (
                  <div
                    key={i}
                    className="flex-1 flex items-end justify-center h-full relative"
                  >
                    {val !== null ? (
                      <div
            ...
            <div className="text-[10px] text-brown-muted mt-2 text-right">
              14-day mood
            </div>
          </div>
          ...
          {/* Session Companion */}
          <div className="px-6 py-8">
            <h2 className="font-serif text-[22px] text-brown mb-2">
              Between sessions
            </h2>
            <p className="text-[15px] text-brown-muted leading-relaxed mb-8">
              Working with Dr. Maya Chen. Stage 2 of 4 — moving through
              avoidance.
            </p>

            <div className="mb-8">
              <span className="text-[11px] uppercase tracking-widest text-brown-muted font-medium mb-4 block">
                Insights from Thursday
              </span>
              <ul className="flex flex-col gap-3">
                <li className="flex gap-3 text-[15px] leading-relaxed text-brown">
                  <span className="text-brown-muted mt-1">—</span>
                  <span>
                    You named perfectionism as the reason you avoid starting the
                    report.
                  </span>
                </li>
                <li className="flex gap-3 text-[15px] leading-relaxed text-brown">
            ...
            <div className="mb-8">
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex gap-3 items-start">
                  <Check
                    className="w-4 h-4 mt-[3px] text-brown"
                    strokeWidth={2}
                  />
                  <span className="text-[15px] leading-relaxed text-brown line-through opacity-60">
                    10-minute walk before noon
                  </span>
                </li>
                <li className="flex gap-3 items-start">
                  <Square
                    className="w-4 h-4 mt-[3px] text-brown-muted"
                    strokeWidth={1.5}
                  />
            ...
            <div className="mb-8 p-5 bg-[#F4EFE6] rounded-sm">
              <span className="text-[11px] uppercase tracking-widest text-brown-muted font-medium mb-2 block">
                Next step
              </span>
          ...
          <button className="w-full px-6 py-6 flex items-center justify-between text-left group">
            <div>
              <div className="font-serif text-[18px] text-brown mb-1">
                Deeper progress
              </div>
              <div className="text-[13px] text-brown-muted">
                Streak, full goals, and 30-day view
              </div>
            </div>
            <ChevronRight
              className="w-4 h-4 text-brown-muted group-hover:text-brown transition-colors"
              strokeWidth={1.5}
            />
          </button>
        </div>
        ...
        <div className="absolute bottom-0 w-full bg-paper border-t border-brown-light px-6 pb-8 pt-4 flex justify-between items-center z-10">
          <button className="flex flex-col items-center gap-1 w-12 relative">
            ...
            <span className="font-serif text-[12px] text-brown absolute -bottom-4">
              Home
            </span>
          </button>
          <button className="flex flex-col items-center gap-1 w-12">
            <MessageCircle
              className="w-[22px] h-[22px] text-brown-muted"
              strokeWidth={1.5}
            />
          </button>
          <button className="flex flex-col items-center gap-1 w-12">
